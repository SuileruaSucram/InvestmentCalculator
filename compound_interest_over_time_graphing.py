...
def main():
    ...
    for years in range (1, 50):
        ...
        print(f'Balance over time: ${round(investment_calculator.total, 2)}')
    print(f'\nInitial Investment: ${round(initial_investment, 2)}, at {interest_rate}%, compounding {interval}, final balance: ${round(investment_calculator.total, 2)}')
